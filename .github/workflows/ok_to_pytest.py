...
def test_bfs_0():
    run_ok_test("test_ses06_solution_bfs_0")

def test_bfs_track_path_0():
    run_ok_test("test_ses06_solution_bfs_track_path_0")

def test_bfs_track_path_1():
    run_ok_test("test_ses06_solution_bfs_track_path_1")

def test_create_bfs_graph_0():
    run_ok_test("test_ses06_solution_create_bfs_graph_0")

def test_create_bfs_graph_1():
    run_ok_test("test_ses06_solution_create_bfs_graph_1")
